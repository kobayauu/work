...
PLATEN_INFO OptionToPlatenInfo( GTX6OPTION Option )
{
...
PLATEN_HEIGHT OptionToPlatenHeight( GTX6OPTION Option )
{
...
WHITEDATA_TYPE OptionToWhiteData( GTX6OPTION Option )
{
	...
	WhiteDataType.iWhiteTime		= GTX6_GetPrintTime( Option );
...
//	WhiteDataType.iWhiteCount
	WhiteDataType.iWhiteMax			= GTX6_GetWhiteness( Option );
...
ENVIRONMENT_TYPE OptionToEnvironData( GTX6OPTION Option )
{
	...
	GTX_SUB_OptionToEnvironData( (BYTE *) &EnvironType, TYPE_GTX6 );
...
//	OutPutInfo.fInkLimit_A_Param
	...
	OutPutInfo.EnvironType			= OptionToEnvironData( Option );
